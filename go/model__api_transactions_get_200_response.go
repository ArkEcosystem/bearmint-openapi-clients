...
// ApiTransactionsGet200Response struct for ApiTransactionsGet200Response
type ApiTransactionsGet200Response struct {
...
func NewApiTransactionsGet200Response() *ApiTransactionsGet200Response {
	this := ApiTransactionsGet200Response{}
	return &this
}
...
func (o ApiTransactionsGet200Response) MarshalJSON() ([]byte, error) {
...
type NullableApiTransactionsGet200Response struct {
	value *ApiTransactionsGet200Response
	isSet bool
}

func (v NullableApiTransactionsGet200Response) Get() *ApiTransactionsGet200Response {
	return v.value
}

func (v *NullableApiTransactionsGet200Response) Set(val *ApiTransactionsGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableApiTransactionsGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableApiTransactionsGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiTransactionsGet200Response(val *ApiTransactionsGet200Response) *NullableApiTransactionsGet200Response {
	return &NullableApiTransactionsGet200Response{value: val, isSet: true}
}

func (v NullableApiTransactionsGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiTransactionsGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true

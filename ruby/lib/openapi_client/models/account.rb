...
module OpenapiClient
  class Account
    ...
    # The id of the object.
    attr_accessor :locked_balances

    # The id of the object.
    attr_accessor :stakes
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'locked_balances')
        self.locked_balances = attributes[:'locked_balances']
      end

      if attributes.key?(:'stakes')
        self.stakes = attributes[:'stakes']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          nonce == o.nonce &&
          balances == o.balances &&
          locked_balances == o.locked_balances &&
          stakes == o.stakes &&
    ...
    def hash
      [id, address, public_key, name, nonce, balances, locked_balances, stakes, validator, metadata, created_at, updated_at].hash
    end

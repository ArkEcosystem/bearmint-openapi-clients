...
module OpenapiClient
  class Block
    ...
    # The id of the object.
    attr_accessor :byzantine_validators

    # The id of the object.
    attr_accessor :last_commit_info
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'byzantine_validators')
        self.byzantine_validators = attributes[:'byzantine_validators']
      end

      if attributes.key?(:'last_commit_info')
        self.last_commit_info = attributes[:'last_commit_info']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          height == o.height &&
          header == o.header &&
          byzantine_validators == o.byzantine_validators &&
          last_commit_info == o.last_commit_info &&
    ...
    def hash
      [id, hash, height, header, byzantine_validators, last_commit_info, created_at, updated_at].hash
    end
